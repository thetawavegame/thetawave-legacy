...
pub fn generate_configs() {
    confgen!("bindings_config.ron", "debug_lines_config.ron", "display_config_640.ron", "display_config_960.ron",
             "display_fullscreen.ron", "sounds_config.ron", "spritesheets_config.ron");
}
