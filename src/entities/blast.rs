...
pub fn fire_blast(entities: &Entities, blast_resource: &ReadExpect<SpriteResource>, sprite_number: usize, fire_position: Vector3<f32>, mut damage: f32, x_velocity: f32, y_velocity: f32, speed: f32, allied: bool, crit_chance: f32, lazy_update: &ReadExpect<LazyUpdate>) {
...
pub fn fire_double_blast(entities: &Entities, blast_resource: &ReadExpect<SpriteResource>, sprite_number: usize, fire_position: Vector3<f32>, mut damage: f32, x_velocity: f32, y_velocity: f32, speed: f32, allied: bool, crit_chance: f32, lazy_update: &ReadExpect<LazyUpdate>) {
